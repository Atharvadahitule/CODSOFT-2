...
("CALCULATOR APP BY ATHARVA DAHITULE")
...
me.geometry("354x460")
me.title("CALCULATOR")
melabel = Label(me, text="CALCULATOR", bg='White', font=("Calibri", 20, 'bold'))
...
metext = Entry(me, font=("Courier New", 16, 'bold'), textvar=textin, width=22, bd=5, bg='white')
metext.pack()
...
butequal = Button(me, padx=151, pady=14, bd=4, bg='light blue', command=equlbut, text="=", font=("Courier New", 16, 'bold'))
